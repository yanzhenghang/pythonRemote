...
if __name__ == '__main__':
    ...
    Dir = '/home/zhangyifan/yanzhenghang/pythonProject/Statistical_Learning/Mnist/'

    # 获取训练集及标签
    print('start read transSet')
    trainDataList, trainLabelList = loadData(Dir + 'mnist_train.csv') #'../Mnist/mnist_train.csv'

    # 获取测试集及标签
    print('start read testSet')
    testDataList, testLabelList = loadData(Dir + 'mnist_test.csv') #'../Mnist/mnist_test.csv'
