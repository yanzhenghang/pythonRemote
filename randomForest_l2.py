...
DF2SPSS_N.to_csv('DF2SPSS_N.csv',encoding='gbk',index=False)
DF2SPSS_P.to_csv('DF2SPSS_P.csv',encoding='gbk',index=False)

dataToPanduan.to_csv('dataToPanduan.csv',encoding='gbk',index=False)
dataPanduan.to_csv('dataPanduan.csv',encoding='gbk',index=False)
...
print(dfOut)
dfOut.to_csv('dfOut_2nd.csv',encoding='gbk',index=True)
