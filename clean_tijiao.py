...
trainingDataNames = trainingDataNames0
...
ABC_test = processForTest(ABC_test, ABC_columns)
print('Saving FINAL_OUT_v1_test.csv')
ABC_test.to_csv(remotePath+'FINAL_OUT_test2nd_v2.csv',encoding="utf_8_sig",index=False, sep=',')
print('Finished!')
