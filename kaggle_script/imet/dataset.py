...
N_CLASSES = 1103
myDir = "/home/yanzhenghang/kaggle/kernel/1.190413 pretrained Resnet50 + focal loss/"
DATA_ROOT = Path('../input/imet-2019-fgvc6' if ON_KAGGLE else myDir+'../input/imet-2019-fgvc6')
