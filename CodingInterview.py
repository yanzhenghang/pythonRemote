...
#215. Kth Largest Element in an Array
    def __partSort(self, nums:list, l:int, r:int):
        #length = r - l + 1
...
#204. Count Primes
    ...
    def strStr(self, haystack: str, needle: str) -> int:
        ...
        while True:#i
            ...
            i = i + 1
#15. 3Sum
    def threeSum(self, nums: list) -> list:#List[List[int]]:
        nums.sort()
        lth = len(nums)
        res = []
...
#206. Reverse Linked List
print( Solution().reverseList(ll1) )

##215. Kth Largest Element in an Array
print( Solution().findKthLargest([3,2,1,5,6,4],2) )
print( Solution().findKthLargest([2,1],1) )
...
print(Solution().canJump([2,0,0,0,2,0,0,0]))
